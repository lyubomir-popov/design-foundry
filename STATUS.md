...
- Lane Q is active: Q1 and Q2 are landed and archived in `HISTORY.md`. Next for Q is to decide whether the remaining compatibility-only halo radius fields should stay in the persisted/runtime shape or be retired behind an explicit migration.
