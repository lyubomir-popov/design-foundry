...
Status: P1-P5 groundwork is complete and archived in `HISTORY.md`. The active question is whether same-size authored variants should become first-class before the saved-file redesign.
